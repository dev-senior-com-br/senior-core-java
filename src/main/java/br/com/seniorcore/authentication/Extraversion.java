...
public class Extraversion {
  ...
  **/
  @ApiModelProperty(required = true, value = "Faceta de socialização.")
  ...
  **/
   ...
   * @return cheerfulness
  **/
  @ApiModelProperty(required = true, value = "Faceta de alegria.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Faceta de busca de emoção.")
   ...
   * @return friendliness
  **/
  @ApiModelProperty(required = true, value = "Faceta de simpatia.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Faceta de energia.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Faceta de assertividade.")
