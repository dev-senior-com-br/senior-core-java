...
public class Ability {
  ...
  **/
   ...
   * @return resumeId
  **/
  @ApiModelProperty(required = true, value = "Identificador do currículo à qual a habilidade está associada.")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "Descrição da habilidade.")
