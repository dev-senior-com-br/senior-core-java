...
public class PersonalityQuiz {
   ...
   * @return wordCount
  **/
  @ApiModelProperty(required = true, value = "Quantidade de palavras na resposta.")
  ...
  **/
   ...
   * @return questions
  **/
  @ApiModelProperty(required = true, value = "Perguntas do questionário.")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "Descrição do questionário.")
