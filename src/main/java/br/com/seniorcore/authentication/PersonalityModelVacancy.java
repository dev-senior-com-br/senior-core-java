...
public class PersonalityModelVacancy {
  ...
  **/
  @ApiModelProperty(required = true, value = "Escrupulosidade.")
   ...
   * @return openness
  **/
  @ApiModelProperty(required = true, value = "Abertura.")
   ...
   * @return neuroticism
  **/
  @ApiModelProperty(required = true, value = "Alcance emocional.")
   ...
   * @return extraversion
  **/
  @ApiModelProperty(required = true, value = "Extroversão.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Amabilidade.")
