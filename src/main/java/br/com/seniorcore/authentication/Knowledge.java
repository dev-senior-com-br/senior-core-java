...
public class Knowledge {
  ...
  **/
   ...
   * @return resumeId
  **/
  @ApiModelProperty(required = true, value = "Identificador do currículo a qual o conhecimento está associado.")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "Descrição do conhecimento.")
