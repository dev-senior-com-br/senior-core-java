...
public class Conscientiousness {
   ...
   * @return dutifulness
  **/
  @ApiModelProperty(required = true, value = "Faceta de sentido de responsabilidade.")
   ...
   * @return cautiousness
  **/
  @ApiModelProperty(required = true, value = "Faceta de cautela.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Valor desta dimensão")
  ...
  **/
  @ApiModelProperty(required = true, value = "Faceta de realização com esforço.")
  ...
  **/
   ...
   * @return selfEfficacy
  **/
  @ApiModelProperty(required = true, value = "Faceta de autoconfiança.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Faceta de autodisciplina.")
   ...
   * @return orderliness
  **/
  @ApiModelProperty(required = true, value = "Faceta de organização.")
